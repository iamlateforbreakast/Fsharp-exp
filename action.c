 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0400 [state machine transition definition]
 *
 ***********************************************************************/
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0020 [platform bus]
 * - SRS.DMS.CAN.FUNC.0630 [Definition of reserved COB-ID for PDO RET distribution Platform Bus]
 *
 ***********************************************************************/
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0020 [payload bus]
 * - SRS.DMS.CAN.FUNC.0630 [Definition of reserved COB-ID for PDO RET distribution Payload Bus]
 *
 ***********************************************************************/
 /* {{RELAX<GEN-005-M> False positive: all fields are correctly initialised by the macros */
 ...
 *  
 * @requirements
 * - SRS.DMS.CAN.OBS.0040
 * - SRS.DMS.CAN.OBS.0041
 * - SRS.DMS.CAN.OBS.0042
 * - SRS.DMS.CAN.OBS.0043
 * - SRS.DMS.CAN.OBS.0044
 * - SRS.DMS.CAN.OBS.0045
 * - SRS.DMS.CAN.OBS.0046
 * - SRS.DMS.CAN.OBS.0047
 * 
 */
 ...
 *  
 * @requirements
 * - SRS.DMS.CAN.OBS.0060
 * - SRS.DMS.CAN.OBS.0061
 * - SRS.DMS.CAN.OBS.0062
 * - SRS.DMS.CAN.OBS.0063
 * - SRS.DMS.CAN.OBS.0064
 * - SRS.DMS.CAN.OBS.0065 
 * 
 */
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0150 [Platform Bus]
 * - SRS.DMS.CAN.OBS.0020 [PDO TM on Platform Bus]
 */
/***********************************************************************/
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0150 [Payload Bus]
 * - SRS.DMS.CAN.OBS.0020 [PDO TM on Payload Bus]
 */
/***********************************************************************/
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.OBS.0020 [Expedited SDO message for Platform Bus]
 */
/***********************************************************************/
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.OBS.0020 [Expedited SDO message for Payload Bus]
 */
/***********************************************************************/
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.OBS.0020 [Block SDO TM for Platform Bus]
 */
/***********************************************************************/
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.OBS.0020 [Block SDO TM for Payload Bus]
 */
/***********************************************************************/
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0400 [state machine definition]
 * 
 ***********************************************************************/
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0015
 * - SRS.DMS.CAN.FUNC.1010 [Toggle definition]
 *
 ***********************************************************************/
 ...
 * 
 * @requirements
 * - SRS.DMS.CAN.FUNC.1010 [Bdefault usage]
 *
 ***********************************************************************/ 
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.1020 [init value]
 * 
 ***********************************************************************/ 
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0410 [State transition INIT->PRE_OP]
 * - SRS.DMS.CAN.FUNC.0420 [discard any incoming messages for 10Hz event]
 * - SRS.DMS.CAN.FUNC.0430 [Start SYNC Producer/Authorize SDO]
 * - SRS.DMS.CAN.FUNC.1045 [Start Ttoggle Timer]
 * - SRS.DMS.CAN.FUNC.1080 [Entry to PRE_OP]
 ***********************************************************************/ 
CoState CanOpenAction_init10Hz(CoCtx *pCtx)
{
  CoStatus coSts;
  ...
  /* prepare the Heart beat and Sync cycle counters
   * so that the BootUp and Comm Sync messages will be generated
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0420 [discard any incoming messages for 100Hz event]
 ***********************************************************************/ 
 ...
 * @return     CoState  The next state of the CAN Bus Manager
 * @requirements
 * - SRS.DMS.CAN.FUNC.0460 [enable PDO when PRE_OP->OP]
 * - SRS.DMS.CAN.FUNC.0510 [transition PRE_OP->OP]
 *
 ***********************************************************************/ 
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0450 [disable SYNC Producer/SDO when PRE_OP->STOPPED]
 * - SRS.DMS.CAN.FUNC.0520 [transition PRE_OP->STOPPED]
 * 
 ***********************************************************************/ 
 ...
 * 
 * @requirements
 * - SRS.DMS.CAN.FUNC.0540 [PRE_OP->INIT]
 ***********************************************************************/ 
 ...
 * 
 * @requirements
 * - SRS.DMS.CAN.FUNC.1065 [Ttoggle Timeout handling in PRE_OP state]
 * 
 ***********************************************************************/ 
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0660
 * - SRS.DMS.CAN.CMD.0260 [processing]
 * - SRS.DMS.CAN.CMD.0270 [waking up]
 * 
 ***********************************************************************/ 
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0530 [transition OP->PRE_OP]
 * 
 ***********************************************************************/ 
 ...
 * 
 * @requirements
 * - SRS.DMS.CAN.FUNC.0520 [transition OP->STOPPED]
 * - SRS.DMS.CAN.FUNC.0450 [disable SYNC Producer/SDO/PDO when OP->STOPPED]
 * 
 ***********************************************************************/ 
 ...
 * 
 * @requirements
 * - SRS.DMS.CAN.FUNC.1065 [Ttoggle Timeout handling in OP state]
 * - SRS.DMS.CAN.FDIR.0220
 *
 ***********************************************************************/ 
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0530 [SYNC STOPPED->PRE_OP]
 * - SRS.DMS.CAN.FUNC.0430 [enable SYNC Producer/SDO when STOPPED -> PRE_OP/Authorize SDO]
 * 
 ***********************************************************************/ 
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0510 [transition STOPPED->OP]
 * - SRS.DMS.CAN.FUNC.0460 [enable SYNC producer/SDO/PDO when STOPPED->OP]
 *
 ***********************************************************************/ 
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0540 [STOPPED->INIT]
 * 
 ***********************************************************************/ 
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.CMD.0280 [health Status updating]
 * - SRS.DMS.CAN.FDIR.0210
 * - SRS.DMS.CAN.FDIR.0230
 * 
 ***********************************************************************/ 
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.CMD.0220 [master state updating]    
 *
 ***********************************************************************/ 
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.CMD.0195 [NMT command management for master node]
 ***********************************************************************/ 
PRIVATE CoEvt coEvtDecode (CoCtx *pCtx)
{
  CoEvt coEvt;
 ...
 * 
 * @requirements
 * - SRS.DMS.CAN.FUNC.1000 
 * - SRS.DMS.CAN.FUNC.1020 [CToggle updating]
 * - SRS.DMS.CAN.FUNC.1045 [Additional second for Ttoggle]
 * - SRS.DMS.CAN.FUNC.1080 [CToggle updating/HB_reg reset/HealthStatus reset]
 *
 ***********************************************************************/ 
PRIVATE void busRestart(CoCtx *pCtx, Bool chanSwitch)
{
  ...
  /* clear any incoming messages if any */
  busInMsgListDiscard(pCtx);

  /* clear any pending commands */
  slaveCmdQueueClear (pCtx);
  
  /* set the opposite channel if switch requested */
  if (chanSwitch)
  {
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.CMD.0220 [slave state updating]
 * - SRS.DMS.CAN.FUNC.0110
 * - SRS.DMS.CAN.FUNC.0440
 * - SRS.DMS.CAN.FUNC.1040
 * - SRS.DMS.CAN.PERF.0110 [PDO]
 * - SRS.DMS.CAN.PERF.0140
 *
 ***********************************************************************/ 
PRIVATE void cobMsgProcess(CoCtx *pCtx, CoState entryState, CoMsg *pCoMsg)
{
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0430 [NMT management support for 10Hz event]
 * - SRS.DMS.CAN.FUNC.0450 [NMT management support for 10Hz event]
 * - SRS.DMS.CAN.FUNC.0610
 * - SRS.DMS.CAN.FUNC.0620
 * - SRS.DMS.CAN.FUNC.0700
 * - SRS.DMS.CAN.FUNC.0800
 * - SRS.DMS.CAN.FUNC.1030
 * - SRS.DMS.CAN.FUNC.1050 
 * - SRS.DMS.CAN.FUNC.1070 
 * - SRS.DMS.CAN.CMD.0195 [NMT command to Payload sent in Slot 0 of SW cycle]
 * - SRS.DMS.S2.CMD.0185 [NMT command sent at beginning of SW cycle]
 * 
 ***********************************************************************/ 
PRIVATE void cycleProcess(CoCtx *pCtx, CoState entryState)
{
 ...
 * 
 * @requirements
 * - SRS.DMS.CAN.FUNC.0930 [PDO TC transmission]
 * - SRS.DMS.CAN.CMD.0195 [NMT command to Platform sent in Slot 1 of SW cycle]
 ***********************************************************************/ 
PRIVATE void slotProcess(CoCtx *pCtx, CoState entryState)
{
  CoStatus coSts;
 ...
 *
 * * @requirements
 * - SRS.DMS.CAN.CMD.0195 [Send NMT command to Slave Nodes]
 * - SRS.DMS.CAN.CMD.0240 [Request handling]
 * 
 ***********************************************************************/ 
PRIVATE void slaveCmdQueueHandler(CoCtx *pCtx)
{
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0410 [Bootup object sending]
 * 
 ***********************************************************************/ 
PRIVATE void hbMgtHandler(CoCtx *pCtx, CoState entryState)
{
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0070 [Message with RECORD (out)]
 * - SRS.DMS.CAN.FUNC.0630 [RET message building & sending]
 * - SRS.DMS.CAN.FUNC.0640 [RET message building according to Requests and CUC Format]
 * - SRS.DMS.CAN.FUNC.0650 [RET message building according to its OD definition]
 * - SRS.DMS.CAN.CMD.0250 [RET Request handling]
 * - SRS.DMS.CAN.FUNC.0655
 ***********************************************************************/ 
PRIVATE void retReqMsgsBuild(CoCtx *pCtx)
{
  CoStatus coSts;
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0190 [PDO TC Sending]
 * - SRS.DMS.CAN.CMD.0180 [PDO TC request handling]
 * - SRS.DMS.CAN.PERF.0100
 * - SRS.DMS.CAN.PERF.0150
 * - SRS.DMS.CAN.PERF.0160
 * - SRS.DMS.CAN.OBS.0030
 ***********************************************************************/ 
PRIVATE void pdoTcMsgsBuild(CoCtx *pCtx)
{
  CoStatus coSts;
 ...
 *
 * @requirements
 * - SRS.DMS.CAN.FUNC.0070 [Message with RECORD/VAR (in)]
 * - SRS.DMS.CAN.CMD.0080 [TM acquisition]
 * - SRS.DMS.CAN.FUNC.0060 [input: unsigned 8, 32]
 * - SRS.DMS.CAN.FUNC.0180 [PDO TM no check on OD]
 * - SRS.DMS.CAN.FUNC.0190 [PDO TM Data Size]
 * - SRS.DMS.CAN.FUNC.0200 [Buffer Support PDO for SDO Block download completion/Upload request] 
 * - SRS.DMS.CAN.FUNC.0230
 * - SRS.DMS.CAN.FUNC.0310 [Buffer Support PDO for SDO Block download handling]
 ***********************************************************************/ 
PRIVATE void pdoMsgProcess(CoCtx *pCtx, CoMsg *pCoMsg)
{
  Uint nodeIdx;
